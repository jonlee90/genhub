-- Migration: Create RPC function for project detail stats aggregation
-- Replaces 300+ lines of client-side JavaScript aggregations with optimized SQL
...
'Returns comprehensive project statistics including task stats, expense stats, material costs, phase stats, and top assignees. Replaces client-side aggregations for improved performance.';
