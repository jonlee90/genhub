-- Migration: 045_auto_create_phases_tasks_from_templates
-- Description: Replace hardcoded phase creation with template-based automation
-- When a project is created, automatically create phases and tasks from templates
-- Date: 2026-01-03
...
-- ============================================
-- 2. Drop old hardcoded phase creation trigger and function
-- ============================================
-- Drop all possible old trigger names (order matters: trigger first, then function)
DROP TRIGGER IF EXISTS create_project_phases ON public.projects;
