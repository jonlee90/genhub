...
-- This aggregates stats from projects, tasks, expenses, materials, and team
-- Reduces dashboard query from 6 queries to 1 query
...
-- Create refresh function with SECURITY DEFINER and locked search_path
...
COMMENT ON MATERIALIZED VIEW mv_dashboard_kpis IS 'Pre-aggregated dashboard KPIs by company. Refresh via refresh_dashboard_kpis() function. Expected refresh: every 5 minutes.';
