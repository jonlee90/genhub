...
export default {
  ...
  safelist: [
    // Responsive display utilities used in EstimateWizardStepper (ensure generated by JIT)
    "sm:flex",
    "sm:hidden",
    ...
    extend: {
      ...
      keyframes: {
        ...
        glowPulse: {
          ...
          "50%": {
            boxShadow:
              "0 0 20px rgba(0, 27, 81, 0.8), 0 0 30px rgba(0, 27, 81, 0.6)",
          },
        },
        shimmer: {
      ...
      boxShadow: {
        construction:
          "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 27, 81, 0.06)",
        "construction-lg":
          "0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 27, 81, 0.05)",
        "construction-xl":
          "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 27, 81, 0.04)",
