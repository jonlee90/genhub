...
import { ArrowLeft, Users, Settings, Search } from "lucide-react";
...
export function ChatLayout({
  ...
  const { rooms, totalUnread, connectionError, updateRoomUnread } =
    useChatRooms({
      ...
      onUnreadChange: (roomId, count) => {
        console.log(
          "[ChatLayout] Unread changed for room:",
          roomId,
          "count:",
          count,
        );
  ...
  console.log(
    "[ChatLayout] Rendering with rooms:",
    rooms.length,
    "Active room:",
    activeRoomId,
  );
          ...
          {activeRoomId && activeRoom ? (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {connectionError && (
                      <CompactConnectionStatus state="disconnected" />
                    )}
                    <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <MuteRoomDropdown
                    ...
                    isMuted={
                      !!(
                        activeRoom.muted_until &&
                        new Date(activeRoom.muted_until) > new Date()
                      )
                    }
              ...
              {optimisticFunctions && (
                <MessageInput
                  ...
                  addOptimisticMessage={
                    optimisticFunctions.addOptimisticMessage
                  }
            ...
            >
              ...
              <p className="text-sm text-gray-500 max-w-sm">
                Choose a project chat or direct message from the sidebar to
