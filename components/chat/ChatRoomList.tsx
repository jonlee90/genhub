...
import { Building2, MessageSquare, MessageCircle } from 'lucide-react';
...
export function ChatRoomList({ rooms, activeRoomId, onRoomSelect, totalUnread }: ChatRoomListProps) {
