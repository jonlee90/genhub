...
export function EntityAutocomplete({
  ...
  console.log(
    "[EntityAutocomplete] Rendering with query:",
    query,
    "Position:",
    position,
  );
  ...
  useEffect(() => {
    const performSearch = async () => {
      ...
      try {
        ...
        console.log(
          "[EntityAutocomplete] Entity type:",
          entityType,
          "Search query:",
          searchQuery,
        );
        ...
        console.log(
          "[EntityAutocomplete] Search results:",
      ...
      >
            ...
            {ENTITY_TYPES.map((entityType, index) => (
              <button
                ...
                onClick={() => {
                  ...
                  console.log(
                    "[EntityAutocomplete] Entity type selected:",
                    entityType.type,
                  );
                }}
                className={cn(
              ...
              >
                <div
                  className={cn(
                    "p-1.5 rounded-md bg-white border-2 border-gray-200",
                  )}
                >
                  <entityType.icon
                    className={cn("h-4 w-4", entityType.color)}
                  />
                </div>
                <div className="flex-1 text-left">
                  <div className="text-sm font-bold text-construction-blue">
                    {entityType.label}
                  </div>
        ...
        <div className="px-3 py-2 bg-gray-50 border-t-2 border-gray-100 flex items-center justify-between">
          <span className="text-[10px] font-mono text-gray-500">
            <kbd className="px-1 py-0.5 bg-white border border-gray-300 rounded text-[9px]">
              ↑↓
            </kbd>{" "}
            Navigate
          </span>
    ...
    >
      ...
      >
        <Icon
          className={cn(
            "h-4 w-4",
            isSelected ? "text-white" : entityConfig?.color,
          )}
        />
      </div>
