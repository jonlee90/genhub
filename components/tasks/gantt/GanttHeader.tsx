              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    cell.isToday && "bg-construction-blue/15 dark:bg-construction-blue/20 border-l-2 border-r-2 border-construction-blue dark:border-construction-blue shadow-inner ring-1 ring-construction-blue/20 dark:ring-construction-blue/40",
                    cell.isWeekend && !cell.isToday && "bg-gray-100/80 dark:bg-gray-800/50",
                    !cell.isToday && !cell.isWeekend && "hover:bg-gray-50 dark:hover:bg-gray-800/30"
                  )}
                  style={{
                    left: cell.x,
                    width: cell.width,
