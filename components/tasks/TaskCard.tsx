...
export const TaskCard = React.memo(
            ...
            <div className="mb-2 flex items-center gap-2 flex-wrap">
              ...
              <div
                className={cn(
                  ...
                  taskTypeInfo.colorClasses &&
                    taskTypeInfo.colorClasses.bgLight,
              ...
              >
                ...
                />
                <span className="text-[10px] font-black tracking-wide uppercase leading-none text-gray-900 dark:text-gray-100">
                  {taskTypeInfo.name}
                </span>
              </div>
            </div>
  ...
  (prevProps, nextProps) => {
    ...
    const assigneesEqual =
      ...
      prevAssignees?.every(
        (a: any, i: number) => a.id === nextAssignees?.[i]?.id,
      );
