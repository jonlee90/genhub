...
function KPICardSkeleton() {
  return (
    <div className="bg-white rounded-xl p-5 border-2 border-gray-200 shadow-sm animate-pulse">
...
function ChartWidgetSkeleton() {
  return (
    <div className="bg-white rounded-xl p-6 border-2 border-gray-200 shadow-sm animate-pulse">
      {/* Header */}
...
function QuickStatsSkeleton() {
  return (
    <div className="bg-white rounded-xl p-5 border-2 border-gray-200 shadow-sm">
      ...
      <div className="space-y-3">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="flex items-center justify-between pb-3 border-b border-gray-100 last:border-0 animate-pulse">
