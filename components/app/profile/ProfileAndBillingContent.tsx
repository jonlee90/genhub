...
function getIntervalBadgeStyle(planName: string): {
  bgColor: string;
  textColor: string;
  borderColor: string;
} {
...
export default function ProfileAndBillingContent() {
  ...
  const { userData, subscriptionData, planName, planInterval, priceData } =
    profileData;
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[var(--background-subtle)] p-4 rounded-lg">
            ...
            <p className="font-semibold text-lg mt-1 break-all">
              {userData.email}
            </p>
          </div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="flex items-center gap-3 mt-2">
                      <span
                        className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-bold border-2 ${style.bgColor} ${style.textColor} ${style.borderColor}`}
                      >
                        {planName}
                      ...
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-md text-xs font-semibold border ${intervalStyle.bgColor} ${intervalStyle.textColor} ${intervalStyle.borderColor}`}
                      >
          ...
          {showPricing && (
            ...
            >
              ...
              <div className="flex justify-center items-center gap-4 mb-10 bg-[var(--background-subtle)] p-4 rounded-full max-w-xs mx-auto">
                <span
                  className={`text-sm font-medium transition-colors duration-200 ${!isYearly ? "text-[#5059FE]" : "text-gray-500"}`}
                >
                  Monthly
                </span>
                <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                {priceData.map((plan: any, index: number) => {
                  ...
                  const getPlanPrice = () => {
                    if (isFree) return "0";
                    return isYearly
                      ? plan.yearPrice?.toString() || "0"
                      : plan.monthPrice?.toString() || "0";
                  };
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3
                        className={`text-xl font-bold mb-2 flex items-center ${isPro ? "text-purple-600" : isBasic ? "text-[#5059FE]" : ""}`}
                      >
                        {plan.name}
                        {isPro && (
                          <svg
