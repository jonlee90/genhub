...
export function ProjectTeam({
  ...
  const [activeTab, setActiveTab] = useState<"members" | "subcontractors">(
    "members",
  );
  ...
  const teamMembers = useMemo(
    () => team.filter((m) => m.user_id !== null),
    [team],
  );
  const subcontractors = useMemo(
    () => team.filter((m) => m.subcontractor_id !== null),
    [team],
  );
  ...
  const handleRemoveSubcontractor = useCallback(
    async (memberId: string, subcontractorId: string) => {
      setRemovingId(memberId);
      try {
  ...
  return (
    <div className="space-y-4">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <Badge
                          className={cn(
                            "mt-1.5 text-xs font-bold border",
                            roleConfig.color,
                          )}
                        >
                          {roleConfig.label}
                        ...
                        {costs &&
                          (costs.taskCount > 0 ||
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                              ...
                              {formatCurrency(costs.expenseCosts)} expenses
                            </p>
                          )}
                      </div>
      ...
      <AddSubcontractorModal
        ...
        existingSubcontractorIds={subcontractors
