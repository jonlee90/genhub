...
export function ProjectTaskSummarySkeleton() {
  return (
    <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-construction-lg p-6 animate-pulse">
      {/* Header */}
...
export function TeamCostSummaryCardSkeleton() {
  return (
    <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-construction-lg p-5 animate-pulse">
      {/* Header */}
