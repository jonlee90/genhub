 ...
 * Uses ResponsiveModal with construction theme
 */
...
export function ConflictDialog({
  ...
  console.log("[ConflictDialog] Rendering:", {
    isOpen,
  ...
  const handleResolutionChange = (
    ...
    console.log("[ConflictDialog] Resolution changed:", {
      conflictType,
      resolution,
    });
      ...
      <div className="space-y-4">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-sm text-yellow-800">
            This marker was edited offline and on the server. Please choose
            which version to keep for each conflict.
          </p>
        </div>
    ...
    <div className="border-2 border-gray-200 rounded-lg p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
          ...
          <ConflictVersionContent conflict={conflict} version="local" />
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-3">
          ...
          <ConflictVersionContent conflict={conflict} version="server" />
...
function ConflictVersionContent({
  ...
  const value =
    version === "local" ? conflict.localVersion : conflict.serverVersion;
  ...
  if (conflict.conflictType === "content") {
    return (
      <p className="text-sm text-gray-900 line-clamp-3">{value || "(empty)"}</p>
    );
  }
