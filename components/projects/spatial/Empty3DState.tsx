...
export function Empty3DState({ onUploadClick, className }: Empty3DStateProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-6 h-6 border-t-4 border-l-4 border-construction-blue opacity-20" />
      <div className="absolute top-0 right-0 w-6 h-6 border-t-4 border-r-4 border-construction-blue opacity-20" />
      <div className="absolute bottom-0 left-0 w-6 h-6 border-b-4 border-l-4 border-construction-blue opacity-20" />
      <div className="absolute bottom-0 right-0 w-6 h-6 border-b-4 border-r-4 border-construction-blue opacity-20" />
        ...
        <div className="text-center mb-6 md:mb-8">
          <div className="inline-flex items-center justify-center mb-4 md:mb-6">
            <div className="relative">
              {/* Pulsing rings */}
              <div className="absolute inset-0 bg-construction-blue opacity-10 rounded-2xl animate-ping" />
              <div className="absolute inset-0 bg-construction-blue opacity-20 rounded-2xl animate-pulse" />

              {/* Icon container */}
              <div className="relative p-4 md:p-6 bg-gradient-to-br from-[var(--construction-blue)] to-[#002666] rounded-2xl border-4 border-white shadow-2xl">
          ...
          {features.map(({ icon: Icon, title, description }) => (
            <div
              ...
              className={cn(
                ...
                'active:border-construction-blue active:bg-blue-50/30',
                'transition-all duration-150',
                'group'
              )}
            >
              <div className="p-2 bg-white border-2 border-gray-200 rounded-lg w-fit mb-2 md:mb-3 group-active:border-construction-blue group-active:bg-construction-blue transition-all">
        ...
        <div className="text-center">
          <button
            ...
            className={cn(
              ...
              'bg-construction-blue text-white font-bold uppercase tracking-wide text-sm md:text-base',
              'active:scale-[0.98] active:bg-construction-blue/90',
              'transition-all duration-150',
              'border-2 md:border-4 border-construction-blue',
              'group'
            )}
          >
