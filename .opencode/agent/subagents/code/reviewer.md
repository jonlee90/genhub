...
- Apply `vercel-react-best-practices` skill for React/Next.js performance reviews
...
2. Apply `vercel-react-best-practices` when reviewing React/Next.js code for performance issues.
3. Share a short review plan (files/concerns to inspect, including security aspects) and ask to proceed.
4. Provide concise review notes with suggested diffs (do not apply changes), including any security concerns.
