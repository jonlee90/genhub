...
```
/context update for Next.js 16
  ↓
Agent: "What changed in Next.js 16?
  [A] API changes
  [B] Deprecations
  [C] New features
  [D] Breaking changes
...
Line 15:
  ...
  + App router is now default in Next.js 16 (pages/ still supported with opt-in)

Line 42:
  + ## Metadata API (New in v15)
  + 
  + Next.js 16 introduces new metadata API for SEO optimization.
...
Line 67:
  ...
  + 
  + **Migration Steps**:
  + 1. Update to Next.js 16: `npm install next@15`
