...
test.describe("3D Viewer Tests", () => {
  test("Navigate to project and verify 3D viewer loads", async ({ page }) => {
    ...
    await page.goto(
      "http://localhost:3000/app/projects/cac08f15-4a7d-4606-ae02-0cf7cc45240a",
      {
    ...
    console.log(
      `Errors: ${errors.length}, AbortErrors: ${abortErrors.length}, PluginErrors: ${pluginErrors.length}`,
    );
  });
  ...
  test("Capture 3D viewer screenshot", async ({ page }) => {
    ...
    const screenshotPath =
      "/Users/jonathanlee/Desktop/genhub/output/3d-viewer-test-result.png";
