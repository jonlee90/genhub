      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="p-2 bg-construction-blue/10 rounded-lg border-2 border-construction-blue/20">
                <Receipt className="h-5 w-5 text-construction-blue" />
              </div>
              <div className="text-xs font-mono uppercase tracking-wider text-construction-blue/60">Total</div>
            </div>
            <div className="text-4xl font-black text-construction-blue leading-none mb-1">{stats.total}</div>
            <div className="text-sm font-bold text-gray-600">Expenses</div>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
            ...
            <div className="text-4xl font-black text-construction-accent leading-none mb-1">{stats.pending}</div>
            <div className="text-sm font-bold text-gray-600">Need Review</div>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-xs font-mono uppercase tracking-wider text-construction-green/60">Approved</div>
            </div>
            <div className="text-4xl font-black text-construction-green leading-none mb-1">{stats.approved}</div>
            <div className="text-sm font-bold text-gray-600">Confirmed</div>
          </div>
        </div>
          ...
          <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="p-2 bg-construction-red/10 rounded-lg border-2 border-construction-red/20">
                <AlertCircle className="h-5 w-5 text-construction-red" />
              </div>
              <div className="text-xs font-mono uppercase tracking-wider text-construction-red/60">Rejected</div>
            </div>
            <div className="text-4xl font-black text-construction-red leading-none mb-1">{stats.rejected}</div>
            <div className="text-sm font-bold text-gray-600">Declined</div>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-xs font-mono uppercase tracking-wider text-construction-blue/60">Value</div>
            </div>
            <div className="text-4xl font-black text-construction-blue leading-none mb-1">{formatCurrency(stats.totalAmount)}</div>
            <div className="text-sm font-bold text-gray-600">Total Cost</div>
          </div>
        </div>
      </div>
