      ...
      <Card className="border-2 border-gray-200 dark:border-gray-700 shadow-construction">
        <CardContent className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="space-y-2 p-4 bg-gray-50 dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <Skeleton className="h-24 w-24 rounded-lg bg-gray-200 dark:bg-gray-700" />
              <Skeleton className="h-24 w-24 rounded-lg bg-gray-200 dark:bg-gray-700" />
              <Skeleton className="h-24 w-24 rounded-lg bg-gray-200 dark:bg-gray-700" />
            </div>
          </div>
