        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
              ...
              <div className="text-sm font-bold text-gray-600">Subcontractors</div>
            </div>
          </div>
            ...
            <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
              <div className="flex items-center justify-between mb-3">
                <div className="p-2 bg-construction-green/10 rounded-lg border-2 border-construction-green/20">
                  <Briefcase className="h-5 w-5 text-construction-green" />
                </div>
                <div className="text-xs font-mono uppercase tracking-wider text-construction-green/60">
                  Active
                </div>
              </div>
              ...
              <div className="text-sm font-bold text-gray-600">Active Status</div>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
              <div className="flex items-center justify-between mb-3">
                <div className="p-2 bg-construction-yellow/10 rounded-lg border-2 border-construction-yellow/20">
                  <AlertTriangle className="h-5 w-5 text-construction-yellow" />
                </div>
                <div className="text-xs font-mono uppercase tracking-wider text-construction-yellow/60">
                  Warning
                </div>
              </div>
              <div className="text-4xl font-black text-construction-yellow leading-none mb-1">
                {expiringLicenses}
              </div>
              <div className="text-sm font-bold text-gray-600">Expiring Licenses</div>
            </div>
          </div>
            ...
            <div className="relative bg-white border-2 border-gray-200 rounded-lg p-5 shadow-construction hover:shadow-construction-lg transition-all">
              <div className="flex items-center justify-between mb-3">
                <div className="p-2 bg-construction-red/10 rounded-lg border-2 border-construction-red/20">
                  <Shield className="h-5 w-5 text-construction-red" />
                </div>
                <div className="text-xs font-mono uppercase tracking-wider text-construction-red/60">
                  Alert
                </div>
              </div>
              ...
              <div className="text-sm font-bold text-gray-600">Expiring Insurance</div>
            </div>
          </div>
        </div>
      )}
