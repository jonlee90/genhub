...
type TaskTemplateInsert = TaskTemplatesInsert;
type TaskTemplateUpdate = TaskTemplatesUpdate;
...
export async function reorderTaskTemplates(
  ...
  console.log('[reorderTaskTemplates] Reordering tasks for phase:', phaseTemplateId);
