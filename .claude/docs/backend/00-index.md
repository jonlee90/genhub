...
|---|--------|-------|------|-------------|
| 01 | [System Architecture](01-system-architecture.md) | 1,732 | 52KB | 10,000-foot view: 38 server actions, 22 API routes, auth flow, request lifecycle, multi-tenancy, cache invalidation |
| 02 | [Data Model & ERD](02-data-model.md) | 1,437 | 60KB | 42 tables, ER diagrams by domain, column catalog, relationships, RLS policies, 22 RPC functions, enums, indexes, constraints |
...
- **Database:** 42 tables, 1 materialized view, 22 RPC functions, 22 enum types, 30+ indexes
- **Backend:** 38 server actions, 22 API routes, 3 external integrations
- **Migrations:** 58 SQL migration files (Jan 3 - Feb 8, 2026)
